    ...
    >
          ...
          <div className="rl-monitoring-panel__tabs">
                ...
                >
                  ...
                  {tab.id === 'training' && (
                    <span className="tab-status">
                      {(data.realtime?.metrics?.active_algorithms?.length || 0) > 0 && (
            ...
            <div className="quick-status">
              ...
              <div className="quick-status__item">
                ...
                <span className={`value status-${data.realtime?.metrics?.system_status || 'unknown'}`}>
                  {data.realtime?.metrics?.system_status === 'healthy' ? '🟢' : '🟡'}
                  {data.realtime?.metrics?.system_status || 'unknown'}
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="rl-monitoring-panel__footer">
        <div className="footer-info">
          ...
          <span>•</span>
          <span>
            API 狀態: {data.realtime?.status?.overall_health === 'healthy' ? '🟢 正常' : '🔴 異常'}
          </span>
          <span>•</span>
          <span>
            刷新間隔: {refreshInterval / 1000}秒
          </span>
        </div>
      </div>
    </div>
