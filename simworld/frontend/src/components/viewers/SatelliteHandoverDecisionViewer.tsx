...
import SatelliteHandoverDecisionVisualization from './SatelliteHandoverDecisionVisualization'

// Navbar 模態框適配器組件
const SatelliteHandoverDecisionViewer: React.FC<ViewerProps> = ({
...
export default SatelliteHandoverDecisionViewer