    ...
    steps: [
      {
        ...
        instruction: '觀察系統界面，識別主要功能區域：圖表區、控制面板、參數配置區',
        actionType: 'observe',
      ...
      },
      {
        ...
        instruction: '點擊頂部的事件標籤，嘗試切換到不同的測量事件 (A4, D1, D2, T1)',
        actionType: 'click',
      ...
      },
      {
        ...
        expectedResult: '系統開始收集測量數據，狀態指示器顯示「測量中」',
    ...
    steps: [
      {
        ...
        instruction: '閱讀 A4 事件的說明，理解位置補償在衛星通信中的重要性',
        actionType: 'observe',
...
export const InteractiveGuide: React.FC<InteractiveGuideProps> = ({
  ...
  }, [currentStep, completedSteps, guide.steps.length, onStepComplete, onGuideComplete])
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge variant="outline">{guide.estimatedTime} 分鐘</Badge>
            </div>
          </div>
        ...
        <CardContent>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm text-muted-foreground">
                {completedSteps.size}/{guide.steps.length} 步驟完成
              </span>
            </div>
          ...
          <div className="flex gap-2 mb-6">
            {!isActive ? (
              ...
              <Button onClick={pauseGuide} variant="outline" className="flex-1">
            ...
            <Card className="mb-6 border-primary/20">
              <CardHeader>
                <CardTitle className="text-lg flex items-center gap-2">
                  {renderActionIcon(currentStepData.actionType)}
                  步驟 {currentStep + 1}: {currentStepData.title}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="mb-4">{currentStepData.instruction}</p>
                
                {currentStepData.theory && (
                  <Alert className="mb-4">
                    <Lightbulb className="h-4 w-4" />
                    <AlertDescription>
                      <strong>理論背景：</strong> {currentStepData.theory}
                    </AlertDescription>
                  </Alert>
                )}
                ...
                {currentStepData.expectedResult && (
                  <div className="mb-4 p-3 bg-muted rounded-lg">
                    <div className="font-medium text-sm mb-1">預期結果：</div>
                    <div className="text-sm">{currentStepData.expectedResult}</div>
                  </div>
                )}
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" onClick={skipToNextStep}>
          ...
          {progress === 100 && (
            <Alert className="mt-6">
              ...
              <AlertDescription>
                🎉 恭喜！您已完成「{guide.title}」指南。您現在已掌握了相關的操作技能和理論知識。
              </AlertDescription>
            </Alert>
          )}
        </CardContent>
