...
import {
    ParameterDefinition,
    ParameterGroup,
} from '../../../common/EnhancedParameterPanel'
import ViewModeToggle, {
    CompactViewModeSwitch,
} from '../../../common/ViewModeToggle'
        ...
        <div className="h-full flex flex-col bg-white">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
                ...
                <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500">
                        當前模式:{' '}
                        {viewModeManager.currentMode === 'simple'
                            ? '簡易版'
                            : '完整版'}
                    </span>
                </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-xs text-gray-400 mt-2">
                                    ...
                                    {viewModeManager.currentMode === 'simple'
                                        ...
                                        : '完整版'}{' '}
                                    | 參數級別:{' '}
                                    {viewModeManager.config.parameters.level} |
                                    更新間隔:{' '}
                                    {
                                        viewModeManager.config.performance
                                            .updateInterval
                                    }
                                    ms
                                </p>
            ...
            <div className="px-4 py-2 bg-gray-100 border-t border-gray-200 text-xs text-gray-600">
                <div className="flex items-center justify-between">
                    <span>
                        UE 位置: {parameters.uePosition.latitude.toFixed(4)}°,{' '}
                        {parameters.uePosition.longitude.toFixed(4)}°
                    </span>
                    <span>鄰居衛星: {parameters.neighbour_satellite_id}</span>
                    <span>觸發時間: {parameters.time_to_trigger}ms</span>
                </div>
            </div>
        </div>
    )
