...
const EnhancedT1Viewer: React.FC = () => {
    ...
    const handleTriggerEvent = useCallback((eventData: any) => {
        const newRecord: EventTriggerRecord = {
            ...
            sync_status:
                eventData.trigger_details.sync_accuracy_ms < 50
                    ? 'good'
                    : 'poor',
        }
            ...
            <div className="viewer-header">
                <div className="title-section">
                    ...
                    <div className="subtitle">
                        基於 3GPP TS 38.331 規範 | GNSS 時間同步 |
                        服務時間窗口管理
                    </div>
                </div>
                        ...
                        <div className="panel-content">
                            <div className="history-stats">
                                ...
                                <div className="stat-item">
                                    ...
                                    <span className="stat-value">
                                        {currentSyncAccuracy.toFixed(2)}ms
                                    </span>
                                </div>
                            </div>
                                    ...
                                    triggerHistory.map((record, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="history-details">
                                                <div>
                                                    經過時間:{' '}
                                                    {record.measurement_values?.elapsed_time?.toFixed(
                                                        1
                                                    )}
                                                    s
                                                </div>
                                                <div>
                                                    剩餘時間:{' '}
                                                    {record.measurement_values?.remaining_service_time?.toFixed(
                                                        1
                                                    )}
                                                    s
                                                </div>
                                                <div>
                                                    同步精度:{' '}
                                                    {record.trigger_details?.sync_accuracy_ms?.toFixed(
                                                        2
                                                    )}
                                                    ms
                                                </div>
                            ...
                            {sib19Status ? (
                                <div className="sync-status">
                                    ...
                                    <div className="status-item">
                                        ...
                                        <span className="status-value">
                                            {sib19Status.time_to_expiry_hours.toFixed(
                                                1
                                            )}
                                            小時
                                        </span>
                                    ...
                                    <div className="status-item">
                                        ...
                                        <span
                                            className={`status-value ${
                                                sib19Status.time_sync_accuracy_ms <
                                                50
                                                    ? 'good'
                                                    : 'warning'
                                            }`}
                                        >
                                            {sib19Status.time_sync_accuracy_ms.toFixed(
                                                2
                                            )}
                                            ms
                                        </span>
