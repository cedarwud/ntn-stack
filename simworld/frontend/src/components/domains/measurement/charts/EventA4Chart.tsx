...
import {
    ...
    DataPoint,
    interpolateRSRP,
} from '../../../../utils/csvDataParser'
import { EventA4Params, AnimationState, EventCondition } from '../types'
// PureA4Chart removed - using simplified chart implementation
...
export const EventA4Chart: React.FC<EventA4ChartProps> = ({
    ...
    const checkA4Conditions = useCallback(
        (rsrpValue: number): { enter: boolean; leave: boolean } => {
            const effectiveValue =
                rsrpValue + DEFAULT_PARAMS.Ofn + DEFAULT_PARAMS.Ocn

            // A4-1 (Entering condition): Mn + Ofn + Ocn – Hys > Thresh
            const enterCondition =
                effectiveValue - DEFAULT_PARAMS.Hys > DEFAULT_PARAMS.Thresh
    ...
    return (
        <div className="event-a4-chart" style={{ width, height }}>
            ...
            <div className="chart-container" style={{ height: height - 80 }}>
                {/* PureA4Chart removed - simplified implementation */}
                <div
                    style={{
                        width: '100%',
                        height: '100%',
                ...
                >
                    <p>
                        Event A4 Chart - Core implementation available in
                        EventA4Viewer
                    </p>
                </div>
            </div>
            ...
            <div className="event-info">
                <div className="event-params">
                    ...
                    <div className="param-grid">
                        ...
                        <span>
                            Report Amount: {DEFAULT_PARAMS.reportAmount}
                        </span>
                    </div>
                </div>
            </div>
