...
const EnhancedD2Viewer: React.FC<EnhancedD2ViewerProps> = ({
    ...
    const handleTriggerEvent = useCallback((eventData: any) => {
        const newRecord: EventTriggerRecord = {
            ...
            satellite_id:
                eventData.measurement_values?.reference_satellite || 'unknown',
        }
            ...
            <div className="viewer-header">
                <div className="title-section">
                    ...
                    <div className="subtitle">
                        基於 3GPP TS 38.331 規範 | 多因子衛星選擇算法 |
                        論文研究級數據精度
                    </div>
                </div>
