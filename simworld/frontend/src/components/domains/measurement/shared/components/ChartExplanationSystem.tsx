...
const CHART_EXPLANATIONS: Record<string, ExplanationContent> = {
    A4: {
        title: 'A4 事件 - 位置補償測量',
        description:
            'A4 事件用於測量和補償 UE 位置誤差，確保定位精度滿足服務要求。',
        keyPoints: [
            '監控 UE 與參考位置的距離差異',
            '當距離差超過門檻值時觸發位置補償',
            '補償範圍限制在 ±3km 以內',
    ...
    D1: {
        title: 'D1 事件 - 雙重距離測量',
        description:
            'D1 事件監控 UE 與參考位置的距離變化，支援全球任意參考位置設定。',
        keyPoints: [
            '同時監控兩個距離門檻值',
            '支援全球化地理座標設定',
            '提供距離變化趨勢分析',
    ...
    D2: {
        ...
        examples: ['Starlink 衛星追蹤', 'OneWeb 網路優化', '衛星切換預測'],
        relatedConcepts: [
            'SGP4 軌道模型',
            'TLE 軌道根數',
            'LEO 衛星星座',
    ...
    T1: {
        title: 'T1 事件 - 時間同步監控',
        description:
            'T1 事件監控 GNSS 時間同步狀態，確保時間精度滿足系統要求。',
        keyPoints: [
            '監控 GNSS 時間同步精度 (< 10ms)',
            '檢測時鐘偏移量 (± 50ms)',
            '提供時間窗口管理',
        ...
        examples: ['5G 網路時間同步', '金融交易時間戳', '科學實驗時間基準'],
        relatedConcepts: [
            'GNSS 時間系統',
            'UTC 協調世界時',
            '時間同步協議',
    ...
    SIB19: {
        title: 'SIB19 統一平台',
        description:
            'SIB19 提供統一的衛星資訊廣播，為所有測量事件提供一致的數據基礎。',
        keyPoints: [
            '統一的衛星星曆和時間基準',
            '支援所有測量事件的數據需求',
            '提供事件特定的數據萃取',
        ...
        examples: ['多事件協調測量', '系統級性能優化', '標準化數據交換'],
        relatedConcepts: [
            '3GPP NTN 標準',
            '系統資訊廣播',
            '衛星通信協議',
                ...
                <CardContent>
                    <Tabs value={activeTab} onValueChange={setActiveTab}>
                        ...
                        <TabsContent value="details" className="mt-4">
                            <div className="space-y-4">
                                {/* 技術細節 */}
                                {contentFilter.showTechnicalDetails &&
                                    renderCollapsibleSection(
                                        'technicalDetails',
                                        '技術細節',
                                ...
                                {/* 相關概念 */}
                                {contentFilter.showRelatedConcepts &&
                                    renderCollapsibleSection(
                                        'relatedConcepts',
                                        '相關概念',
