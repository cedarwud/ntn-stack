                ...
                if (data.success && data.constellations) {
                    ...
                    data.constellations.forEach((item: any) => {
                        if (updated[item.constellation]) {
                            updated[item.constellation].satelliteCount =
                                item.satellite_count || 0
    ...
    return (
        <div className="constellation-selector">
            <div className="mb-3">
                ...
                {loading && (
                    <span className="text-sm text-blue-500">載入中...</span>
                )}
            </div>
                    ...
                    >
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                            ...
                            {info.dataAvailability.totalDays > 0 && (
                                <div>
                                    📊 數據: {info.dataAvailability.totalDays}{' '}
                                    天
                                </div>
                            )}
                        </div>
                    ...
                    <CardContent>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">
                                        {selectedConstellation.coverage}
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-gray-500">
                                    ...
                                    <span className="font-medium">
                                        {selectedConstellation.orbitAltitude}
                                    </span>
                                </div>
                            </div>
                            <div className="space-y-2">
                        ...
                        {selectedConstellation.dataAvailability.start && (
                            <div className="mb-4 p-3 bg-blue-50 rounded text-xs text-gray-600">
                                💡 數據期間:{' '}
                                {selectedConstellation.dataAvailability.start} ~{' '}
                                {selectedConstellation.dataAvailability.end}
                                <br />
