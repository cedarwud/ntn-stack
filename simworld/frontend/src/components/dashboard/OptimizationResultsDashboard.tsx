...
const OptimizationResultsDashboard: React.FC<
...
> = ({
    ...
    const [activeTab, setActiveTab] = useState<
        'overview' | 'comparison' | 'trends' | 'parameters'
    >('overview')
    ...
    const fetchOptimizationResults = useCallback(async () => {
        try {
            ...
            const response = await fetch(
                `/api/v1/ai-decision/optimization/report?days=${days}`
            )
        ...
        datasets: [
            {
                ...
                data: optimizationResults
                    .map((r) => r.after_metrics.latency_ms)
                    .reverse(),
            ...
            },
            {
                label: '吞吐量 (Mbps)',
                data: optimizationResults
                    .map((r) => r.after_metrics.throughput_mbps)
                    .reverse(),
            ...
            },
            {
                label: '覆蓋率 (%)',
                data: optimizationResults
                    .map((r) => r.after_metrics.coverage_percentage)
                    .reverse(),
    ...
    const parameterImpactData = {
        labels: selectedOptimization
            ? Object.keys(selectedOptimization.parameter_changes)
            : [],
        datasets: [
            {
                label: '變化百分比',
                data: selectedOptimization
                    ? Object.values(selectedOptimization.parameter_changes).map(
                          (change) => Math.abs(change.change_percentage)
                      )
                    : [],
            ...
            <div className="summary-cards">
                ...
                <div className="summary-card">
                    ...
                    <span className="value positive">
                        +
                        {summary
                            ? (summary.average_improvement * 100).toFixed(1)
                            : 0}
                        %
                    </span>
                </div>
                <div className="summary-card">
                    ...
                    <span className="value cost">
                        ${summary?.total_cost_savings.toFixed(0) || 0}
                    </span>
                </div>
            </div>
                    ...
                    {optimizationResults.slice(0, 5).map((result) => (
                        <div
                            ...
                            className={`optimization-item ${
                                selectedOptimization?.optimization_id ===
                        ...
                        >
                            ...
                            <div className="optimization-details">
                                ...
                                <span className="trigger">
                                    觸發: {result.trigger_reason}
                                </span>
                                <span className="changes">
                                    參數變更:{' '}
                                    {
                                        Object.keys(result.parameter_changes)
                                            .length
                                    }
                                </span>
                            </div>
                        ...
                        <div className="comparison-section">
                            ...
                            <div className="metrics-grid">
                                <div className="metric">
                                    ...
                                    <span>
                                        {
                                            selectedOptimization.before_metrics
                                                .latency_ms
                                        }
                                        ms
                                    </span>
                        ...
                        <div className="comparison-section">
                            ...
                            <div className="metrics-grid">
                                <div className="metric">
                                    ...
                                    <span>
                                        {
                                            selectedOptimization.after_metrics
                                                .latency_ms
                                        }
                                        ms
                                    </span>
                    ...
                    <div className="cost-benefit-analysis">
                        ...
                        <div className="cost-benefit-grid">
                            <div className="cost-benefit-item">
                                ...
                                <span>
                                    $
                                    {selectedOptimization.cost_benefit_analysis.total_cost.toFixed(
                                        2
                                    )}
                                </span>
                            </div>
                            <div className="cost-benefit-item">
                                ...
                                <span>
                                    $
                                    {selectedOptimization.cost_benefit_analysis.total_benefit.toFixed(
                                        2
                                    )}
                                </span>
                            </div>
                            ...
                            <div className="cost-benefit-item">
                                <label>回收期:</label>
                                <span>
                                    {selectedOptimization.cost_benefit_analysis.payback_period_hours.toFixed(
                                        1
                                    )}
                                    小時
                                </span>
            ...
            <div className="trends-summary">
                ...
                <div className="trends-stats">
                    <div className="trend-stat">
                        <label>最佳表現參數:</label>
                        <span>
                            {summary?.best_performing_parameter || 'N/A'}
                        </span>
                    </div>
                    <div className="trend-stat">
                        <label>最大改善指標:</label>
                    ...
                    <div className="trend-stat">
                        <label>每日優化頻率:</label>
                        <span>
                            {summary?.optimization_frequency_per_day.toFixed(
                                1
                            ) || 0}{' '}
                            次/天
                        </span>
            ...
            <div className="improvement-trends">
                ...
                <div className="improvement-metrics">
                    {optimizationResults.slice(0, 10).map((result) => (
                        ...
                        >
                            <span className="cycle">
                                #{result.optimization_cycle}
                            </span>
                            <div className="improvements">
                                {Object.entries(result.improvements).map(
                                    ([metric, value]) => (
                                        <span
                                            key={metric}
                ...
                <>
                    <div className="parameter-changes">
                        ...
                        <div className="parameters-list">
                            {Object.entries(
                                selectedOptimization.parameter_changes
                            ).map(([param, change]) => (
                                    ...
                                    <div className="parameter-change">
                                        ...
                                        >
                                            ...
                                            {change.change_percentage > 0
                                                ? '+'
                                                : ''}
                                            {change.change_percentage.toFixed(
                                                1
                                            )}
                                            %)
                                        </span>
                    ...
                    <div className="optimization-info">
                        ...
                        <div className="info-grid">
                            <div className="info-item">
                                ...
                                <span>
                                    {
                                        selectedOptimization.implementation_time_seconds
                                    }
                                    秒
                                </span>
                            </div>
                            <div className="info-item">
                                <label>觸發原因:</label>
                                <span>
                                    {selectedOptimization.trigger_reason}
                                </span>
                            </div>
                            <div className="info-item">
                                <label>信心度:</label>
                                <span>
                                    {(
                                        selectedOptimization.confidence_score *
                                        100
                                    ).toFixed(1)}
                                    %
                                </span>
    ...
    return (
        <div className="optimization-results-dashboard">
            <div className="dashboard-header">
                ...
                <div className="header-controls">
                    ...
                    <button
                        ...
                        className="manual-optimize-button"
                    >
                        🚀 手動優化
                    </button>
            ...
            <div className="demo-notice">
                ...
                <span>
                    目前顯示的是演示數據。真實優化結果需要連接到後端優化引擎並執行實際的優化作業。
                </span>
            </div>
...
function generateMockOptimizationResults(days: number): OptimizationResult[] {
    ...
    for (let i = 0; i < Math.min(days * 3, 30); i++) {
        ...
        const afterMetrics: OptimizationMetrics = {
            ...
            throughput_mbps:
                beforeMetrics.throughput_mbps * (1 + improvements.throughput),
            coverage_percentage:
                beforeMetrics.coverage_percentage * (1 + improvements.coverage),
            power_consumption_w:
                beforeMetrics.power_consumption_w * (1 + improvements.power),
            cpu_utilization:
                beforeMetrics.cpu_utilization * (1 + improvements.cpu),
            memory_utilization:
                beforeMetrics.memory_utilization * (1 + improvements.memory),
            cost_per_hour: beforeMetrics.cost_per_hour * 0.95,
            user_satisfaction: Math.min(
                10,
                beforeMetrics.user_satisfaction * 1.05
            ),
        }
...
function generateOptimizationSummary(
    ...
    const totalImprovements = results
        .map((r) => Object.values(r.improvements))
        .flat()
    const avgImprovement =
        totalImprovements.reduce((sum, imp) => sum + imp, 0) /
        totalImprovements.length

    return {
        total_optimizations: results.length,
        successful_optimizations: successful,
        average_improvement: avgImprovement,
        total_cost_savings: results.reduce(
            (sum, r) =>
                sum +
                (r.cost_benefit_analysis.total_benefit -
                    r.cost_benefit_analysis.total_cost),
            0
        ),
