...
const SatelliteConnectionIndicator: React.FC<
    SatelliteConnectionIndicatorProps
> = ({
    currentConnection,
    predictedConnection,
    isTransitioning,
    ...
    const getSignalBars = (strength: number) => {
        ...
        const normalizedStrength = Math.max(
            0,
            Math.min(100, (strength + 100) * 2)
        ) // -100dBm to 0dBm -> 0 to 100
            ...
            >
                <div className="card-header">
                    ...
                    <div className="connection-status">
                        ...
                        {connection.isPredicted && (
                            <div className="status-dot predicted"></div>
                        )}
                    </div>
                </div>
                ...
                <div className="satellite-metrics">
                    <div className="metric-item">
                        ...
                        <span className="metric-value">
                            {connection.elevation.toFixed(1)}°
                        </span>
                    </div>
                    <div className="metric-item">
                        <span className="metric-label">方位角</span>
                        <span className="metric-value">
                            {connection.azimuth.toFixed(1)}°
                        </span>
                    </div>
                    <div className="metric-item">
                        <span className="metric-label">距離</span>
                        <span className="metric-value">
                            {connection.distance.toFixed(0)} km
                        </span>
                    </div>
                </div>
                ...
                <div className="signal-info">
                    <div className="signal-strength">
                        ...
                        <span className="signal-value">
                            {formatSignalStrength(connection.signalStrength)}
                        </span>
                    </div>
            ...
            <div className="handover-stage-display">
                ...
                <div className="stage-header">
                    ...
                    <span className="stage-progress">
                        {(stage.stageProgress * 100).toFixed(0)}%
                    </span>
                </div>
                    ...
                    <div className="connection-line old-connection">
                        ...
                        <div
                            className={`line-visual ${
                                stage.stage === 'preparing' ? 'flashing' : ''
                            } ${
