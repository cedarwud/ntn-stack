...
import D2EventChart from '../components/handover/D2EventChart';
...
const RealD2EventDemo: React.FC = () => {
    ...
    const handleConstellationChange = (newConstellation: 'starlink' | 'oneweb') => {
        ...
        <div className="real-d2-event-demo">
            <div className="demo-container">
                ...
                <p className="demo-subtitle">
                    使用真實衛星數據和 Moving Reference Location (MRL) 計算來可視化 3GPP D2 換手事件
                </p>
                ...
                <div className="controls-panel">
                    <div className="control-group">
                        ...
                        <div className="toggle-buttons">
                            <button 
                                className={`toggle-button ${constellation === 'starlink' ? 'active' : ''}`}
                                onClick={() => handleConstellationChange('starlink')}
                            >
                                Starlink
                            </button>
                            <button 
                                className={`toggle-button ${constellation === 'oneweb' ? 'active' : ''}`}
                                onClick={() => handleConstellationChange('oneweb')}
                            >
                                OneWeb
                            </button>
                        </div>
                    ...
                    <div className="control-group">
                        ...
                        <input
                            ...
                            onChange={(e) => handleThresholdChange('thresh1', Number(e.target.value))}
                            min={300}
                            max={800}
                            step={25}
                        />
                    ...
                    <div className="control-group">
                        ...
                        <input
                            ...
                            onChange={(e) => handleThresholdChange('thresh2', Number(e.target.value))}
                            min={200}
                            max={600}
                            step={25}
                        />
                    ...
                    <div className="control-group">
                        ...
                        <input
                            ...
                            onChange={(e) => handleThresholdChange('hysteresis', Number(e.target.value))}
                            min={5}
                            max={50}
                            step={5}
                        />
                ...
                <div className="info-panels">
                    <div className="info-panel">
                        ...
                        <p>D2 換手在以下條件觸發：</p>
                        <ul>
                            <li>Ml1 (服務衛星 MRL 距離) &gt; 閾值1 + 滯後效應</li>
                            <li>Ml2 (目標衛星 MRL 距離) &lt; 閾值2 - 滯後效應</li>
                        </ul>
                        <p className="note">
                    ...
                    <div className="info-panel">
                        ...
                        {currentTime ? (
                            <>
                                <p><strong>選定時間:</strong> {currentTime.toLocaleTimeString()}</p>
