...
describe('🧪 Phase 1.5 統一平台整合測試', () => {
    ...
    describe('📡 SIB19 統一基礎平台測試', () => {
        ...
        it('應該正確顯示不同事件類型的資訊子集', async () => {
            const eventTypes = ['A4', 'D2'] as const
        ...
        it('應該支援自動更新機制', async () => {
            ...
            // 檢查自動更新按鈕
            const autoUpdateToggle = screen.getByRole('button', {
                name: /自動更新/,
            })
    ...
    describe('📊 統一圖表架構測試', () => {
        it('應該正確載入事件配置', () => {
            const eventTypes = Object.keys(EVENT_CONFIGS) as Array<
                keyof typeof EVENT_CONFIGS
            >
