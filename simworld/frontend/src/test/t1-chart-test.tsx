    ...
    return (
        ...
        >
            ...
            <div style={{ marginTop: '20px', color: '#ccc' }}>
                ...
                <ol>
                    <li>
                        <strong>狀態曲線：</strong> 應顯示矩形脈衝，在 5-15
                        秒區間內為 1 (啟用)，其餘為 0 (未啟用)
                    </li>
                    <li>
                        <strong>垂直線：</strong> 5 秒處應有進入線，15
                        秒處應有離開線
                    </li>
                    <li>
                        <strong>時間窗口：</strong> 5-15
                        秒區間應有半透明綠色背景
                    </li>
                    <li>
                        <strong>動畫控制：</strong> 紅色虛線游標應可控制當前時間
                        Mt
                    </li>
                    <li>
                        <strong>狀態邏輯：</strong> 當 Mt 在 [5000, 15000]
                        範圍內時事件啟用
                    </li>
                    <li>
                        <strong>🆕 浮動視窗：</strong>{' '}
                        動畫解說面板應為可拖動的浮動視窗，與 A4 事件相同
                    </li>
                    <li>
                        <strong>🆕 拖拽功能：</strong>{' '}
                        可以拖動解說面板到螢幕任意位置
                    ...
                    <li>
                        <strong>🆕 透明度控制：</strong> 可以調整面板透明度
                        (0.3-1.0)
                    </li>
                    <li>
                        <strong>🆕 面板控制：</strong>{' '}
                        包含最小化、展開/收起、技術細節切換、關閉等按鈕
                    </li>
                </ol>
            </div>
        </div>
