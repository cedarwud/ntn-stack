...
from .communication.communication_simulation_service import (
...
class SionnaSimulationService(SimulationServiceInterface):
    ...
    async def generate_doppler_plots(
        ...
        """
        logger.info(
            f"Generating Doppler plots for scene '{scene_name}' at {output_path}"
        )
    ...
    async def generate_channel_response_plots(
        ...
        """
        logger.info(
            f"Generating channel response plots for scene '{scene_name}' at {output_path}"
        )
