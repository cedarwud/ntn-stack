...
class OrbitalPhaseDisplacementEngine:
    ...
    def analyze_satellite_phase(self, satellite_data: Dict[str, Any]) -> SatellitePhaseInfo:
        ...
        # 提取軌道參數
        mean_anomaly = orbital_elements.get('mean_anomaly_deg', 0.0)
        raan = orbital_elements.get('raan_deg', 0.0)
        inclination = orbital_elements.get('inclination_deg', 0.0)
        orbital_period = satellite_data.get('orbital_period_minutes', 96.0)
