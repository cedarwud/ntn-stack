...
sys.path.insert(0, '/app/netstack/src/pipeline')
...
def check_validation_snapshot_quality(stage_num):
    """檢查驗證快照品質"""
    try:
        snapshot_file = f'/app/data/validation_snapshots/stage{stage_num}_validation.json'
...
def run_stage_specific(target_stage, validation_level='STANDARD'):
    ...
    try:
        ...
        if target_stage == 1:
            ...
            from pipeline.stages.stage1_orbital_calculation.stage1_processor import Stage1Processor
            ...
            stage3 = Stage3Processor(
                input_dir='/app/data/intelligent_filtering_outputs',
            ...
            stage5 = Stage5Processor(
                signal_analysis_dir='/app/data/signal_analysis_outputs',
            ...
            stage6 = Stage6Processor(
                data_integration_dir='/app/data/data_integration_outputs',
