...
class RouterManager:
    ...
    def _register_single_optional_router(self, router_config: dict) -> bool:
        ...
        try:
            ...
            module = importlib.import_module(
                router_config["import_path"], package=__package__
            )
    ...
    def get_router_status(self) -> dict:
        ...
        return {
            ...
            "success_rate": (
                (successful_routers / total_routers) * 100 if total_routers > 0 else 0
            ),
    ...
    def validate_router_health(self) -> dict:
        ...
        for router_name in core_routers:
            ...
            core_router_status[router_name] = (
                router_info["success"] if router_info else False
            )
