...
python Desktop/paper/comprehensive/run_all_tests.py

或指定特定階段:
python Desktop/paper/comprehensive/run_all_tests.py --stage 1.2
python Desktop/paper/comprehensive/run_all_tests.py --stage 1.3
python Desktop/paper/comprehensive/run_all_tests.py --stage all
"""
...
class PaperReproductionTestRunner:
    ...
    def __init__(self):
        ...
        self.end_time = None
        self.base_path = "/home/sat/Desktop/paper"
    ...
    async def run_stage_test(self, stage_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if success:
                ...
                print(f"   通過測試: {passed_tests}/{total_tests} ({success_rate:.1f}%)")
    ...
    def _generate_comprehensive_report(self) -> Dict[str, Any]:
        ...
        total_passed = sum(result.get("passed_tests", 0) for result in self.test_results.values())
        ...
        return {
            ...
            "overall_summary": {
                ...
                "stage_success_rate": f"{(successful_stages/total_stages*100):.1f}%" if total_stages > 0 else "0%",
                "total_individual_tests": total_tests,
                "total_passed_tests": total_passed,
                "total_failed_tests": total_tests - total_passed,
                "overall_test_success_rate": f"{(total_passed/total_tests*100):.1f}%" if total_tests > 0 else "0%"
            },
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        # 檢查失敗的階段
        failed_stages = [
            stage_id for stage_id, result in self.test_results.items()
    ...
    def _print_comprehensive_summary(self, report: Dict[str, Any]):
        ...
        print(f"\n📊 總體統計:")
        print(f"   測試階段: {summary['successful_stages']}/{summary['total_stages']} 成功 ({summary['stage_success_rate']})")
        print(f"   個別測試: {summary['total_passed_tests']}/{summary['total_individual_tests']} 通過 ({summary['overall_test_success_rate']})")
        ...
        for stage_id, result in self.test_results.items():
            ...
            print(f"      測試通過: {result['passed_tests']}/{result['total_tests']} ({result['success_rate']:.1f}%)")
    ...
    async def _save_comprehensive_report(self, report: Dict[str, Any]):
        ...
        report_filename = f"/home/sat/Desktop/paper/comprehensive/paper_reproduction_report_{timestamp}.json"
