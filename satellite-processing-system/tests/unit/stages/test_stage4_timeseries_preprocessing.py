...
class TestStage4DataProcessing:
    ...
    def test_load_stage3_data_file_exists(self, stage4_processor):
        ...
        # 檢查Stage3輸出是否存在
        stage3_output_path = Path("/satellite-processing/data/outputs/stage3/signal_analysis_output.json")
...
class TestStage4OutputValidation:
    ...
    def test_output_files_created(self, stage4_processor):
        ...
        # 檢查主要輸出文件存在
        output_dir = Path("/satellite-processing/data/outputs/stage4")
    ...
    def test_output_json_format_valid(self, stage4_processor):
        ...
        # 檢查主要輸出文件JSON有效性
        output_file = Path("/satellite-processing/data/outputs/stage4/enhanced_timeseries_output.json")
