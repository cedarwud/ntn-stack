...
class TestStage1PureAcademicGradeA(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.real_oneweb_tle = {
            ...
            'source_file': '/satellite-processing/data/tle_data/oneweb/tle/oneweb_25262.tle'
        }
    ...
    def test_source_file_verification_real_paths_only(self):
        ...
        # 測試真實數據路徑模式
        real_paths = [
            '/satellite-processing/data/tle_data/starlink/tle/starlink_25262.tle',
            '/satellite-processing/data/tle_data/oneweb/tle/oneweb_25262.tle'
        ]
