...
class TestStage6DataProcessing:
    ...
    def test_load_stage5_data_file_exists(self, stage6_processor):
        ...
        # 檢查Stage5輸出是否存在
        stage5_output_path = Path("/satellite-processing/data/outputs/stage5/data_integration_output.json")
...
class TestStage6OutputValidation:
    ...
    def test_output_files_created(self, stage6_processor):
        ...
        # 檢查主要輸出文件存在
        output_dir = Path("/satellite-processing/data/outputs/stage6")
    ...
    def test_output_json_format_valid(self, stage6_processor):
        ...
        # 檢查主要輸出文件JSON有效性
        output_file = Path("/satellite-processing/data/outputs/stage6/dynamic_pool_planning_output.json")
