...
執行環境:
- 容器內執行: docker exec satellite-dev python /app/scripts/run_refactored_six_stages.py
- 主機執行: cd satellite-processing-system && python scripts/run_refactored_six_stages.py
"""
