...
class PhysicsValidator:
    ...
    def __init__(self):
        ...
        # 物理常數 (國際標準值)
        self.SPEED_OF_LIGHT = physics_consts.SPEED_OF_LIGHT  # m/s (定義值)
        ...
        constant_validation = {
            "constants_check": {
                "speed_of_light": {
                    ...
                    "standard_value": physics_consts.SPEED_OF_LIGHT,
                    "unit": "m/s",
                    "correct": self.SPEED_OF_LIGHT == physics_consts.SPEED_OF_LIGHT
                },
                "earth_radius": {
