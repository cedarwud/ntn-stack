...
class StorageManager:
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        # 存儲路徑配置
        self.primary_storage_path = Path(self.config.get('primary_storage_path', '/satellite-processing/data/storage'))
        self.backup_storage_path = Path(self.config.get('backup_storage_path', '/satellite-processing/data/backups'))
