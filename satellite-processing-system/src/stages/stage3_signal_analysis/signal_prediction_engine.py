...
# 常數定義（從TrajectoryPredictionEngine提取）
...
class SignalPredictionEngine:
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        self.rsrp_thresholds = {
            'good_threshold_dbm': self.config.get('good_threshold_dbm', noise_floor + 30),  # -90 dBm
            'poor_threshold_dbm': self.config.get('poor_threshold_dbm', -110.0),
            'handover_threshold_dbm': self.config.get('handover_threshold_dbm', -105.0)
        }
